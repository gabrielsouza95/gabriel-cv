...
const spaceTexture = new THREE.TextureLoader().load('./assets/image_files/space.jpg');
scene.background = spaceTexture;

// Avatar

const portraitTexture = new THREE.TextureLoader().load('./assets/image_files/profile.jpg');
...
const moonTexture = new THREE.TextureLoader().load('./assets/image_files/moon.jpg');
const normalTexture = new THREE.TextureLoader().load('./assets/image_files/normal.jpg');
